...
export async function taskManager(messages: CoreMessage[]) {
  try {
    ...
    1. "proceed": First use the 'Search the web for information' tool and If the provided information is sufficient to address the query effectively, choose this option to proceed with the research and formulate a response.
